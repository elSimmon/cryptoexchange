                    ...
                    <div class="col-md-4 mb-4 stretch-card transparent">
                        <div class="card card-tale">
                            <div class="card-body">
                                ...
                                <p class="fs-30 mb-2"><span style="text-decoration: line-through;">N</span>{{number_format(4006)}}</p>
                                <p>10.00% (30 days)</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 mb-4 stretch-card transparent" >
                        <div class="card card-light-blue">
                            <div class="card-body text-light text-bold">
                                <p class="mb-4" style="position:relative;">USD Wallet</p>
                                <p class="fs-30 mb-2">USD{{number_format(34040)}}</p>
                                <p>2.00% (30 days)</p>
                            </div>
                        </div>
                    </div>
