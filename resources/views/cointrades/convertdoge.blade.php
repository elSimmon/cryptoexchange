...
@section('content')
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-bold text-capitalize text-primary">How Much Dogecoin do you want to sell?</h4>
                        <p class="card-description">
                            Enter Dogecoin Value Below
                        </p>
                        <form method="post" action="{{route('trade-dogecoin')}}" autocomplete="off">@csrf
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-primary text-white">Doge Amount</span>
                                    </div>
                                    <input type="text" id="btcAmount" name="btcAmount" class="form-control" placeholder="0.005888" onkeyup="getBitcoinRate()" autocomplete="off" required>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function getDollarRate(){
            let endpoint = 'https://bitpay.com/api/rates/doge/usd'
            ...
            $.ajax({
                ...
                success: function (result){
                    ...
                    let btc = parseFloat(usd / result.rate)
