...
@section('content')
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-bold text-capitalize text-primary">How Much Ethereum do you want to sell?</h4>
                        <p class="card-description">
                            Enter Ethereum Value Below
                        </p>
                        <form method="post" action="{{route('trade-ethereum')}}" autocomplete="off">@csrf
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-primary text-white">ETH Amount</span>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        function getDollarRate(){
            let endpoint = 'https://bitpay.com/api/rates/eth/usd'
