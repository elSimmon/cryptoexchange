      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" id="navbarPages"  href="#" aria-haspopup="true" aria-expanded="false">
                Rates
              </a>
            </li>
            <li class="nav-item dropdown">
          ...
          <!-- Button -->
          <a class="navbar-btn btn btn-sm btn-primary lift ms-auto" href="{{route('login')}}" target="_blank">
            Sign In
          </a>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-5 col-lg-6 order-md-2">
            ...
            <!-- Image -->
            <img src="{{asset('landkit/assets/img/illustrations/blockchain-1.jpg')}}" class="img-fluid mw-md-150 mw-lg-130 mb-6 mb-md-0" alt="..." data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-12 col-md-7 col-lg-6 order-md-1" data-aos="fade-up">
            ...
            <p class="lead text-center text-md-start text-muted mb-6 mb-lg-8">
              Trade Bitcoin, Buy and Sell Gift Cards, Recieve instant payment in your Bank account.
            </p>

            <!-- Buttons -->
            <div class="text-center text-md-start">
              <a href="{{route('register')}}" class="btn btn-primary shadow lift me-1">
                Let's get you started <i class="fe fe-arrow-right d-none d-md-inline ms-3"></i>
              </a>
        ...
        <div class="row content-center">
          <div class="col-12 col-md-4" data-aos="fade-up">
            ...
            <div class="icon text-primary mb-3">
              <img src="https://img.icons8.com/color/48/000000/bitcoin--v3.png"/>
            </div>
          ...
          <div class="col-12 col-md-4" data-aos="fade-up" data-aos-delay="50">
            ...
            <!-- Icon -->
            <div class="icon text-primary mb-3">
             <img src="https://img.icons8.com/office/50/000000/online-support.png"/>
           </div>
            ...
            <!-- Text -->
            <p class="text-secondary mb-6 mb-md-0">
              We are always available 24/7 to give you the support and customer service when needed.
            </p>
          ...
          <div class="col-12 col-md-4" data-aos="fade-up" data-aos-delay="100">
            ...
            <!-- Icon -->
            <div class="icon text-primary mb-3">
              <img src="https://img.icons8.com/fluent/50/000000/online-payment-.png"/>
            </div>
            ...
            <p class="text-secondary mb-0">
              All trades are processed as quickly as possible and you get paid instantly in your desired bank account.
            </p>
          ...
          <div class="col-12 col-md-6 col-lg-5 order-md-1" data-aos="fade-right">
            ...
            <div class="card shadow-light-lg lift lift-lg">
              ...
              <div class="card-body">
                ...
                <form>
                  <div class="form-floating">
                    <input type="email" class="form-control form-control-flush" id="cardEmail" placeholder="  Email" style="border: 1px solid blue; padding:3px;">
                    <label for="cardEmail">Email</label>
                  </div>

                  <div class="mt-6">
                    <button class="btn w-100 btn-secondary lift" type="submit">
                      Send me updates
                    </button>
                  </div>
                </form>
          ...
          <div class="col-12 col-md-5 col-lg-6">
            ...
            <div class="w-md-150 w-lg-130 position-relative" data-aos="fade-left">
              ...
              <div class="img-skewed img-skewed-start">
                ...
                <!-- Image -->
                <img src="{{asset('landkit/assets/img/photos/tradingscreen.jpg')}}" class="screenshot img-fluid img-skewed-item" alt="...">
              ...
              <div class="row gx-0">
                <div class="col-12 col-md-6">
                  ...
                  <div class="card-img-slider" data-flickity='{"fade": true, "imagesLoaded": true, "pageDots": false, "prevNextButtons": false, "asNavFor": "#blogSlider", "draggable": false}'>
                    <a class="card-img-start w-100 bg-cover" style="background-image: url(landkit/assets/img/photos/photo-1.jpg);" href="#!">

                      <!-- Image (placeholder) -->
                      <img src="landkit/assets/img/photos/photo-1.jpg" alt="..." class="img-fluid d-md-none invisible">

                    </a>
                    <a class="card-img-start w-100 bg-cover" style="background-image: url(landkit/assets/img/photos/photo-26.jpg);" href="#!">

                      <!-- Image (placeholder) -->
                      <img src="landkit/assets/img/photos/photo-26.jpg" alt="..." class="img-fluid d-md-none invisible">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-5 col-lg-6 order-md-2">
            ...
            <!-- Image -->
            <img src="landkit/assets/img/illustrations/illustration-8.png" alt="..." class="img-fluid mb-6 mb-md-0">
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8 text-center">
            ...
            <span class="badge rounded-pill bg-gray-700-soft mb-4">
              <span class="h6 fw-bold text-uppercase">WE ARE THE BEST</span>
            </span>
