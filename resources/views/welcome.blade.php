      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-5 col-lg-6 order-md-2">
            ...
            <!-- Image -->
            <img src="{{asset('images/user_dashboard.png')}}" class="img-fluid mw-md-150 mw-lg-130 mb-6 mb-md-0" alt="..." data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-12 col-md-7 col-lg-6 order-md-1" data-aos="fade-up">
            ...
            <h1 class="display-3 text-center text-md-start">
              ...
              <span class="text-primary text-hightlighted">Sell Bitcoin, Ethereum, Dogecoin, USD Coin and Gift Cards</span>
            </h1>

            <!-- Text -->
            <p class="lead text-center text-md-start text-muted mb-6 mb-lg-8">
              Sell Bitcoin, Ethereum, Dogecoin, USD Coin and Gift Cards. Instant withdrawals to receive instant payment in your local Bank account.
            </p>
          ...
          <div class="col-12 col-md-6 col-lg-5 order-md-1" data-aos="fade-right">
            ...
            <div class="card shadow-light-lg lift lift-lg">
              ...
              <div class="card-body">
                ...
                <form>
                  <div class="form-floating">
                    <input type="email" class="form-control form-control-flush" id="cardEmail" placeholder="  Email" style="padding:3px;">
...
Our Website is always available 24/7 with uninterrupted service delivery.
                </p>
...
Your bitcoin transactions are stored on a blockchain network and your wallets can not be tempered with.                </p>
          ...
          <div class="col-12 col-md-5 col-lg-6">
            ...
            <div class="w-md-150 w-lg-130 position-relative" data-aos="fade-left">
              ...
              <div class="img-skewed img-skewed-start">
                ...
                <!-- Image -->
                <img src="{{asset('landkit/assets/img/photos/admin-dashboard.png')}}" class="screenshot img-fluid img-skewed-item" alt="Admin Dashboard">
              ...
              <div class="row gx-0">
                <div class="col-12 col-md-6">
                  ...
                  <div class="card-img-slider" data-flickity='{"fade": true, "imagesLoaded": true, "pageDots": false, "prevNextButtons": false, "asNavFor": "#blogSlider", "draggable": false}'>
                    <a class="card-img-start w-100 bg-cover" style="background-image: url(images/phonecall.jpg);" href="#!">

                      <!-- Image (placeholder) -->
                      <img src="landkit/assets/img/photos/photo-1.jpg" alt="..." class="img-fluid d-md-none invisible">

                    </a>
                    <a class="card-img-start w-100 bg-cover" style="background-image: url(images/kate.jpg);" href="#!">
                      ...
                      <div class="card-body">
                        <blockquote class="blockquote text-center mb-0">
                          ...
                          <p class="mb-5 mb-md-7">
                            “I started using iKHENT Exchange a few months since the crypto ban and as a matter of fact, iKHENT Exchange has no contender when it comes to the business of crypto exchange.”
                          </p>

                          <!-- Footer -->
                          <footer class="blockquote-footer">
                            <span class="h6 text-uppercase">John Mannyi</span>
                          </footer>
                    ...
                    <div class="w-100">
                      ...
                      <div class="card-body">
                        <blockquote class="blockquote text-center mb-0">
                          ...
                          <!-- Text -->
                          <p class="mb-5 mb-md-7">
                            “I've never been disappointed by iKHENT Exchange, they are my first choice when it comes to redeeming giftcards and selling my Bitcoin.”
                          </p>

                          <!-- Footer -->
                          <footer class="blockquote-footer">
                            <span class="h6 text-uppercase">Kate Y.</span>
                          </footer>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-12 col-md-7 col-lg-6 order-md-1">
            ...
            <h2>
              ...
              <span class="text-primary">Let us handle the rest</span>.
            </h2>

            <!-- Text -->
            <p class="fs-lg text-gray-700 mb-6">
              We will take care of your bitcoin exchange in a very friendly way all you need is to transfer from your wallet and update your bank account details, we will then take it from there...
            </p>
    ...
    <!-- FAQ -->
    <section id="faqs" class="pt-15 bg-dark">
            ...
            <div class="d-flex">
              ...
              <div class="ms-5">
                ...
                <p class="text-muted mb-6 mb-md-8">
                    iKHENT Exchange is an exchange platform that makes it easy to sell your Bitcoin and gift cards for cash.
                </p>
